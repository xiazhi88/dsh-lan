...
// └─────────────────────────────────────────────────────────────────┘
// dsh-web-mobile 的客户端，内联在 dshgo 里。
//
// ── 为什么内联而不是依赖 ──
//
// 试过用 cordis.patch.yml 多插一行把它挂上。那条路会炸：市场的「一键安装」
// 会热挂载插件，读的正是那张补丁，于是 dsh-web-mobile 被挂了两次 ——
// locale namespace 冲突，**整个 dsh web 起不来**，连市场的卸载页都打不开。
//
// 内联则挂载次数由我们自己控制：只有一次，且不经任何别人的补丁。
// 代价是这份代码要随上游更新手动同步（见 tools/vendor-mobile.mjs）。
//
// ── 来源与许可 ──
//
//   dsh-web-mobile  v2.4.1
//   https://github.com/mexiaosqwq/dsh-web-mobile
//   MIT License, Copyright (c) 2026 mexiaosqwq
//   完整许可见同目录 LICENSE.dsh-web-mobile
//
// 本文件由 tools/vendor-mobile.mjs 生成，请勿手工编辑。
